...
public class FTDISioIds
{
    ...
    public static boolean isDeviceSupported(UsbDevice dev) {
        return com.example.controller.serial.Helpers.exists(ftdiDevices, dev.getVendorId(), dev.getProductId()) ||
                isMicrochipFtdi(dev);

    }

    static boolean isDeviceIdSupported(int vendorId, int productId) {
        return com.example.controller.serial.Helpers.exists(ftdiDevices, vendorId, productId);
    }
}
