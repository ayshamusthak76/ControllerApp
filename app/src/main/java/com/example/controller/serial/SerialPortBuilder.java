...
//        List<UsbDevice> devices =  java.util.stream.Stream.of(allDevices.values())
...
//            devices = java.util.stream.Stream.of(getPossibleSerialPorts(context))
...
//
//            List<UsbDeviceStatus> newDevices = java.util.stream.Stream.of(getPossibleSerialPorts(context))
//                    .map(UsbDeviceStatus::new)
